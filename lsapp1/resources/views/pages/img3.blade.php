    ...
    <div class="container">
        ...
        <div class="row">
          <blockquote class="blockquote-reverse">
            <p> Get it down. Take chances. It may be bad, but it's the only way you can do anything really good.
              <footer>William Faulkner</footer>

              </p>
          </blockquote>
            <div class="col-md-12"> 
                <img src="Images/p3.jpg" class="center-block img-responsive img-thumbnail" width="400" height="400" />
                  <br><br>
                <b>Description</b>
